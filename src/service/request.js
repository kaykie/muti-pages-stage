...
export default function request(options) {
  ...
  // options.url = options.url.replace('/api/component/saas', '');
  // if (options.url.indexOf('camera') === -1)
    options.url = config.publicUrl + options.url;

  // if (options.url.indexOf('open') === -1 && options.url.indexOf('app') === -1 && options.url.indexOf('alarm') === -1)
  //   options.url = config.publicUrl + options.url;
  // else
  //   options.url = options.url.replace('/api/component/saas', '');
